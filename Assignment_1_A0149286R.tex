...
\subsection{}
$\vec{a}=(T,L)$ with payoff $u_1(\vec{a})=7,u_2(\vec{a})=1$

\subsection{}
$\vec{a}_1=(T,L)$ with payoff $u_1(\vec{a}_1)=5,u_2(\vec{a}_1)=5$ \\
$\vec{a}_2=(B,R)$ with payoff $u_1(\vec{a}_2)=4,u_2(\vec{a}_2)=4$

\subsection{}
$\vec{a}=(T,A)$ with payoff $u_1(\vec{a})=5,u_2(\vec{a})=5$
...
\subsection{}
\subsubsection{Pure}
$\vec{a}_1=(T,L)$ with payoff $u_1(\vec{a}_1)=3,u_2(\vec{a}_1)=5$ \\
$\vec{a}_2=(B,R)$ with payoff $u_1(\vec{a}_2)=5,u_2(\vec{a}_2)=3$
\subsubsection{Mixed}
...
\subsection{}
\subsubsection{Pure}
$\vec{a}_1=(T,L)$ with payoff $u_1(\vec{a}_1)=10,u_2(\vec{a}_1)=5$ \\
$\vec{a}_2=(C,R)$ with payoff $u_1(\vec{a}_2)=3,u_2(\vec{a}_2)=7$
\subsubsection{Mixed}
